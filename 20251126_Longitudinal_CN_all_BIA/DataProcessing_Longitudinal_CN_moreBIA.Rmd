...
df <- df %>%
  mutate(
    ...
    # Segmental variables other frequencies
    ...
    SL_UPPERtoLOWER_ratio = SL_upper / SL_lower,
    SW_UPPERtoLOWER_ratio = SW_upper / SW_lower
  )
...
#vars_check_outlier <- c(
  "bmi", "icwIntracellularWater", "ecwExtracellularWater", "tbwTotalBodyWater", "protein",
  "mineral", "fat", "slmSoftLeanMass", "ffmFatFreeMass", "smmSkeletalMuscleMass", "pbf", "whr",
  "sw_ra", "sw_la", "sw_tr", "sw_rl", "sw_ll", "ecw_tbw_total", "ecw_tbw_ra", "ecw_tbw_la",
  "ecw_tbw_tr", "ecw_tbw_rl", "ecw_tbw_ll", "sl_ra", "sl_la", "sl_tr", "sl_rl", "sl_ll",
  "bfmControl", "ffmControl", "bcm", "boneMineralContent", "ac", "amc", "vfa", "bmr", "tbw_ffm",
  "ra_z1", "la_z1", "tr_z1", "rl_z1", "ll_z1", "ra_z5", "la_z5", "tr_z5", "rl_z5", "ll_z5",
  "ra_z50", "la_z50", "tr_z50", "rl_z50", "ll_z50", "ra_z250", "la_z250", "tr_z250", "rl_z250", "ll_z250",
  "ra_z500", "la_z500", "tr_z500", "rl_z500", "ll_z500", "ra_z1000", "la_z1000", "tr_z1000", "rl_z1000", "ll_z1000",
  "ra_xc5", "la_xc5", "tr_xc5", "rl_xc5", "ll_xc5", "ra_xc50", "la_xc50", "tr_xc50", "rl_xc50", "ll_xc50",
  "ra_xc250", "la_xc250", "tr_xc250", "rl_xc250", "ll_xc250", "ra_pa5", "la_pa5", "tr_pa5", "rl_pa5", "ll_pa5",
  "ra_pa50", "la_pa50", "tr_pa50", "rl_pa50", "ll_pa50", "ra_pa250", "la_pa250", "tr_pa250", "rl_pa250", "ll_pa250",
  "PA50_total", "smi", "ra_r5", "ra_r50", "ra_r250", "la_r5", "la_r50", "la_r250", "tr_r5", "tr_r50", "tr_r250",
  "rl_r5", "rl_r50", "rl_r250", "ll_r5", "ll_r50", "ll_r250", 
  "pbcm", "ecw_tbw", "Water_Lean_RA", "Water_Lean_LA", "Water_Lean_RL", "Water_Lean_LL",
  "ECW_ICW_RA", "ECW_ICW_LA", "ECW_ICW_RL", "ECW_ICW_LL", "SW_upper", "SW_lower", "SL_upper", "SL_lower",
  "Water_Lean_upper", "Water_Lean_lower", "ECW_ICW_upper", "ECW_ICW_lower", "R_upper", "R_lower",
  "Xc_upper", "Xc_lower", "PA_upper", "PA_lower", "R5_upper", "R5_lower", "R250_upper", "R250_lower",
  "Xc5_upper", "Xc5_lower", "Xc250_upper", "Xc250_lower", "z1_upper", "z1_lower", "z5_upper", "z5_lower",
  "z50_upper", "z50_lower", "z250_upper", "z250_lower", "z500_upper", "z500_lower", "z1000_upper", "z1000_lower",
  "PA5_upper", "PA5_lower", "PA250_upper", "PA250_lower", "MMSE", "SNSB_attention", "SNSB_language",
  "SNSB_visuospatial", "SNSB_memory", "SNSB_frontal"
#)
```
...
vars_check_outlier <- c(
  ...
  "SW_upper", "SW_lower", "SL_upper", "SL_lower",
  "R5_upper", "R5_lower",
  "Xc5_upper", "Xc5_lower", "z1_upper", "z1_lower", "z5_upper", "z5_lower",
  "SL_UPPERtoLOWER_ratio", "SW_UPPERtoLOWER_ratio"
)
